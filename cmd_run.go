...
take precedence over environment variables.`
	...
	var (
		...
		sessionStringFlag = cmd.StringOpt("session-string", sessionString, "(ASSUME_ROLE_SESSION_STRING) A string that will be part of the resulting User ID in the spoke account.") // lint:ignore-length
